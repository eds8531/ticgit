...
#Lets users manually enter words.
...
def update_manual():
    ...
    while m == 0:
        ...
        new_word = input('Type the word you would like to add to your list> ')
        #try:
        ...
        word_def = json.loads(r.text)
        print(word_def['id'])
        print(word_def['results'][0]['lexicalEntries'][0]['entries'][0]['senses'][0]['definitions'])
        term_dict = {}
        term_dict['term'] = word_def['id']
        term_dict['definition'] = word_def['results'][0]['lexicalEntries'][0]['entries'][0]['senses'][0]['definitions']
        term_dict['date'] = date.today()
        term_dict['consecutive right'] = 0
        term_dict['card used'] = 0
        output.append(term_dict)

        again = input("Press 'y' to enter a new word or any other key to return to the main menu.> ")
...
def fc():
    ...
    while len(word_list_today) > 0:
        ...
        for i in word_list_today[0]['definition']:
            print('\n\n' + i + '\n\n')
